...
namespace ThoiTrangLaAuthentic.Controllers
{
    public class CheckoutController : Controller
    {
        ...
        public CheckoutController(ThoitrangLaAuthenticDbContext context, INotyfService notyfService)
        {
            _context = context;
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    foreach (var item in cart)
                    {
                        ...
                        orderDetail.ProductId = item.products.ProductId;
                        orderDetail.Amount = item.amount;
                        orderDetail.TotalMoney = donhang.TotalMoney;
                        orderDetail.Price = item.products.Price;
