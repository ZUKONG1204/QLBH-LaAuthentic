...
namespace ThoiTrangLaAuthentic.Controllers
{
    public class ShoppingCartController : Controller
    {
        ...
        public ShoppingCartController(ThoitrangLaAuthenticDbContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public IActionResult AddToCart(int productID, int? amount)
        {
            ...
            try
            {
                ...
                CartItem item = cart.SingleOrDefault(p => p.products.ProductId == productID);
        ...
        public ActionResult Remove(int productID)
        {
            ...
            try
            {
                ...
                CartItem item = gioHang.SingleOrDefault(p => p.products.ProductId == productID);
                if (item != null)
                {
                    gioHang.Remove(item);
                }
